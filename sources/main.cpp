...
DWORD WINAPI MainThread(HMODULE hModule)
{
	...
	if (!srcds) {
		...
		g_pEngineClient->ExecuteClientCmd(
			"setinfo cm_steamid 1337; setinfo cm_steamid_random 1; setinfo cm_steamid_enabled 1; setinfo cm_enabled 1; setinfo cm_version \"3.0.1.1837\"; setinfo cm_drawspray 1; setinfo cm_forcemap \"\"; setinfo cm_fakeconnect 0; setinfo cm_log 0");
